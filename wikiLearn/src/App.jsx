...
function App() {
  ...
  // etats des questions et du score
  ...
  function handleReponse(reponseUtilisateur) {
    ...
    if (indexSuivant < questionsLego.length) {
      ...
      alert("Fin du Quizz ! Tu as gagné " + nouveauxPoints + " XP ! 🎉")
      // Remise à zéro
      setIndexQuestion(0)
      setPointsXp(0)
    }

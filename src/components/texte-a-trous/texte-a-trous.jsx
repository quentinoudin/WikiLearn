...
function QuizTexteATrous() {
  ...
  const isFinished = index >= questionsData.length;
  const currentQuestion = !isFinished ? questionsData[index] : null;
  const parties = currentQuestion ? currentQuestion.texte.split('____') : [];
